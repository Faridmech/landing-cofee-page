...
const summarySentence = `“I drink my Tea <span
...
const checkPlan = function () {
  if (capsuleCheck && bean && quantities && deliveries) {
    ...
    document.getElementById("confirm").addEventListener("click", getOrder)
  } else if (preferences && bean && quantities && grinds && deliveries) {
    document.getElementById("confirm").classList.remove("disabled")
    document.getElementById("confirm").addEventListener("click", getOrder)
  } else {
...
const checkDelivery = () => {
  if (
    ...
    if (choice[4].classList.contains("choice--disabled")) {
...
capsule.addEventListener("click", () => {
  ...
  checkDelivery()
  checkPlan()
  document.getElementById("using-as").textContent = "using"
  document.getElementById("capsule-variation").textContent = ""
...
filter.addEventListener("click", () => {
  ...
  document.getElementById("capsule-variation").textContent = "ground ala "
  document.getElementById("grind").textContent = ". . . "
...
const getOrder = () => {
  ...
  document.getElementById("checkout-price").textContent = finalPrice * multiply
